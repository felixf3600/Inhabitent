...
<div class="widget-content">
   ...
   <p>
      <label for="<?php echo $this->get_field_id('weekdays'); ?>">Monday to Friday: </label>
   ...
   <p>
      <label for="<?php echo $this->get_field_id('saturdays'); ?>">Saturday: </label>
   ...
   <p>
      <label for="<?php echo $this->get_field_id('sundays'); ?>">Sundays: </label>
