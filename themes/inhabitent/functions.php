...
function Inhabitent_starter_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => 'sidebar to the right of the page',
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-2',
		'description'   => 'sidebar to the footer of the page',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function Inhabitent_starter_scripts() {
	...
	wp_enqueue_style('Inhabitent-starter-fa', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/all.min.css');
